                ...
                <Stack spacing={3}>
                    <Box>
                        ...
                        <Typography variant="body1" sx={{ color: "#475569", mt: 1.5 }}>
                            Estas familias profesionales se han seleccionado a partir de tu resultado
                            RIASEC. Úsalas como punto de partida para explorar opciones, no como una
                            decisión cerrada.
                        </Typography>
                    </Box>
                            ...
                            return (
                                <Paper
                                    ...
                                    sx={{
                                        p: 3,
                                        borderRadius: 3,
                                        border: index === 0 ? "1px solid #2563eb" : "1px solid #dbe2f0",
