					...
					<Paper
						...
						<Stack spacing={3}>
							...
							<Alert severity='warning'>
								No hemos encontrado el resultado de esta
								navegación. Más adelante conectaremos la
								recuperación mediante enlace temporal.
							</Alert>
							<Button
			...
			<Container maxWidth='lg'>
				<Stack spacing={3}>
					<Box>
						...
						<Typography
							variant='body1'
							sx={{ color: "#475569", mt: 1.5 }}>
							Estas familias profesionales se han seleccionado a
							partir de tu resultado RIASEC. Úsalas como punto de
							partida para explorar opciones, no como una decisión
							cerrada.
						</Typography>
					</Box>
						...
						{recommendations.map((recommendation, index) => {
							...
							return (
								<Paper
									...
									elevation={0}
									onClick={() =>
										handleScrollToFamily(family.id_familia)
									}
									sx={{
										p: 3,
										borderRadius: 3,
								...
								return (
									<Box
										...
										{cycles.length > 0 ? (
											...
											<Alert severity='info'>
												Aún no hay ciclos cargados para
